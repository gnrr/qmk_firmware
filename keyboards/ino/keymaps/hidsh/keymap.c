...
/* 
  ...
  -------+------+------+------+------+------+------+------+          +------+------+------+------+------+------+------+------+ 
  |  esc | ctrl |  win |  alt | space| MS-M | MS-L |      |          | MB-R | space|  alt | RAISE| LOWER| left | down | right| R4
  -------+------+------+------+------+------+------+------+          +------+------+------+------+------+------+------+------+ 
 */
...
[LY_MAC] = LAYOUT(
  ...
  KC_ESC,  KC_LWIN,  ____, KC_LALT, KC_SPC, KC_MSM, KC_MSL,  xxx,    KC_MSR, KC_SPC, KC_RWIN, RAISE,   LOWER,   KC_LEFT,  KC_DOWN,  KC_RIGHT \
  ),
...
[LY_LINUX] = LAYOUT(
  ...
  ____,    ____,     ____,    ____,  ____,    ____,   ____,   ____,   ____,   ____,   ____,    ____,    ____,    ____,     ____,     ____,    \
  ____,    ____,     ____,    ____,  ____,    ____,   ____,   ____,   ____,   ____,   ____,    ____,    ____,    ____,     ____,     ____,    \
  ____,    ____,     ____,  KC_LALT, ____,    ____,   ____,   ____,   ____,   ____,  KC_RCTL,  ____,    ____,    ____,     ____,     ____     \
  ),
