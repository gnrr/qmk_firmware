...
#include "keymap_jp.h"              // for jis-layout such as JP_XX
...
/*
  ...
  -------+------+------+------+------+------+------+------+          +------+------+------+------+------+------+------+------+
  |半/全 |   1  |   2  |   3  |   4  |   5  |   6  |      |          |   7  |   8  |   9  |   0  |   -  |   ^  |   ¥  |  bs  | R0
  -------+------+------+------+------+------+------+------+          +------+------+------+------+------+------+------+------+
  |  tab |   q  |   w  |   e  |   r  |   t  |      |      |          |   y  |   u  |   i  |   o  |   p  |  @   |   [  | enter| R1
  -------+------+------+------+------+------+------+------+          +------+------+------+------+------+------+------+------+
  | caps |   a  |   s  |   d  |   f  |   g  |      |      |          |   h  |   j  |   k  |   l  |   ;  |   :  |   ]  |      | R2
  -------+------+------+------+------+------+------+------+          +------+------+------+------+------+------+------+------+
  |      |shift |   z  |   x  |   c  |   v  |   b  |      |          |   b  |   n  |   m  |   ,  |   .  |   /  |  up  |   \  | R3
  -------+------+------+------+------+------+------+------+          +------+------+------+------+------+------+------+------+
...
[LY_MAC] = LAYOUT(
  JP_ZHTG,  KC_1,    KC_2,    KC_3,  KC_4,    KC_5,   KC_6,  xxx,    KC_7,   KC_8,   KC_9,    KC_0,   KC_MINUS, JP_CIRC,   JP_YEN,  KC_BSPC, \
  KC_TAB,   KC_Q,    KC_W,    KC_E,  KC_R,    KC_T,   xxx,   xxx,    KC_Y,   KC_U,   KC_I,    KC_O,    KC_P,    JP_AT,    JP_LBRC,  KC_ENT,  \
  KC_CAPS,  KC_A,    KC_S,    KC_D,  KC_F,    KC_G,   xxx,   xxx,    KC_H,   KC_J,   KC_K,    KC_L,    KC_SCLN, JP_COLN,  JP_RBRC,  xxx,     \
  xxx,     KC_LSFT,  KC_Z,    KC_X,  KC_C,    KC_V,   KC_B,  xxx,    KC_B,   KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_UP,    KC_DEL,  \
  KC_ESC,  KC_LALT, LOWER, KC_LWIN, KC_SPC, KC_MSM, KC_MSL,  xxx,    KC_MSR, KC_SPC, KC_RCTL, RAISE,   JP_BSLS, KC_LEFT,  KC_DOWN,  KC_RIGHT \
  ),
