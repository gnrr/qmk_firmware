...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = { {KC_NO,    KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,   KC_F10,   KC_F11,   KC_F12,   KC_DEL},
            ...
            {KC_LSFT,  KC_HOME,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM, KC_DOT,   KC_SLSH,  KC_PGDN,  KC_PGUP},
            {KC_NO,    KC_NO,    KC_NO,    KC_FN0,   KC_LGUI,  KC_BTN2,  KC_ESC,   KC_SPC,   KC_LEFT,  KC_DOWN, KC_UP,    KC_RGHT,  KC_NO,    KC_NO},
            {KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_BTN1,  KC_LGUI,  KC_LCTRL, KC_LSFT,   KC_NO,   KC_NO,    KC_NO,    KC_NO,    KC_NO} },
	...
	[0] = { {KC_NO,    KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,   KC_F10,   KC_F11,   KC_F12,   KC_DEL},
            ...
            {KC_LSFT,  KC_HOME,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM, KC_DOT,   KC_SLSH,  KC_PGDN,  KC_PGUP},
            {KC_NO,    KC_NO,    KC_NO,    KC_FN0,   KC_LGUI,  KC_BTN2,  KC_ESC,   KC_SPC,   KC_LEFT,  KC_DOWN, KC_UP,    KC_RGHT,  KC_NO,    KC_NO},
            {KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_BTN1,  KC_LALT,  KC_LCTRL, KC_LSFT,   KC_NO,   KC_NO,    KC_NO,    KC_NO,    KC_NO} },
